...
def generate_data(im_path):
    ...
    npy_path = im_path.replace('.jpg', '.npy')
...
def parse_args():
    ...
    parser.add_argument('--origin-dir', default='/home/chuanzhi/mnt_2T/wz/datasets/shrimp/auto_cropped',
                        help='original data directory')
    parser.add_argument('--data-dir', default='/home/chuanzhi/mnt_2T/wz/datasets/shrimp/auto_cropped_BL',
...
if __name__ == '__main__':
    ...
    for phase in ['train', 'val']:
        ...
        if phase == 'train':
            img_list = sorted(glob(os.path.join(sub_dir, '*.jpg')))
            sub_phase_list = ['train']
            # sub_phase_list = ['train', 'val']  # ucf原本只有 train 和 test ，自己根据自己的模型去把 train 那部分划分成 train 和 val
